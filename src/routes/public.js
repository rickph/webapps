...
function renderLanding({ leagues, totals, liveGames, upcomingGames, recentResults, leaders, user }) {
  ...
  <style>
    ...
    #hs .hbrand-mark{ width:28px; height:28px; border-radius:50%; background:var(--hs-accent); flex:none; box-shadow:0 0 0 1px var(--hs-accent-strong) inset; }
  ...
  <div id="hs">
    <header class="hsite">
      <div class="wrap hnav-row">
        <a class="hbrand" href="/"><span class="hbrand-mark"></span>HOOPSTATS PILIPINAS</a>
        <nav class="hprimary">
          <a href="/">Home</a>
