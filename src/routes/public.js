  ...
  return page(`${esc(league.name)} | HoopStats`, `
    ...
    <style>
      ...
      @media(max-width:740px){
        .pub-tabs{flex-wrap:wrap!important;overflow-x:visible!important;gap:8px!important;border-bottom:none!important;padding-bottom:4px!important}
        .ptab{flex:1 1 28%!important;-webkit-flex:1 1 28%!important;justify-content:center!important;-webkit-box-pack:center!important;-webkit-justify-content:center!important;padding:10px 6px!important;font-size:10.5px!important;border:1px solid var(--border)!important;border-radius:8px!important;background:var(--dark-2)!important;background-color:var(--dark-2)!important;color:var(--text-2)!important}
        .ptab.active{background:var(--orange-dim)!important;background-color:var(--orange-dim)!important;border-color:var(--orange)!important;color:var(--orange)!important}
      }
    </style>
    <div class="pub-tabs">
